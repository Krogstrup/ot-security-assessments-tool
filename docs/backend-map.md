...
This document is the maintained map for everything under `backend/`.
...
When `backend/` changes, update this file in the same PR.
...
rg -n "^pub mod|^mod |^pub use " backend/src backend/crates
rg -n "^pub fn|route\(" backend/src
```

Ownership intent:
- `backend/src/*`: adapter/runtime layer (HTTP + command wiring).
- `backend/crates/gm-*`: domain/application libraries.
- `backend/signatures/*` and `backend/data/*`: runtime data inputs.
- `backend/bindings/gen/types/*`: generated API contract surface for frontend.
...
- `backend/src/commands/analysis_builders.rs` was deleted and split into two focused modules:
  - `analysis_input_builder.rs` — `build_analysis_input()` only.
  - `capture_context_builder.rs` — `build_capture_context()` only.
- `backend/src/application/mappers/deep_parse.rs` was added as the **canonical DeepParseSnapshot mapper** (all 7 protocols). The duplicate in `analysis.rs` (`build_malware_deep_parse`, Modbus+IEC104 only) was deleted and callers now use this single function.
- `backend/src/application/use_cases/ingest/mod.rs` was thinned to an orchestrator. Extracted:
...
- `backend/src/bin/kusanaginokajiki_web/web_support.rs` was thinned to a re-export shim. Extracted:
...
- `backend/src/bin/web_*.rs` helper files were moved under `backend/src/bin/kusanaginokajiki_web/`.
...
### `backend/src/bin/kusanaginokajiki_web/import_support.rs`
...
## Generated Type Bindings (`backend/bindings/gen/types`)
...
### `backend/bindings/gen/types/AssetInfo.ts`
...
### `backend/bindings/gen/types/AssetSignatureMatch.ts`
...
### `backend/bindings/gen/types/BacnetDetail.ts`
...
### `backend/bindings/gen/types/ConnectionInfo.ts`
...
### `backend/bindings/gen/types/DeepParseInfo.ts`
...
### `backend/bindings/gen/types/DeviceZeekEvents.ts`
...
### `backend/bindings/gen/types/Dnp3Detail.ts`
...
### `backend/bindings/gen/types/Dnp3Relationship.ts`
...
### `backend/bindings/gen/types/EnipDetail.ts`
...
### `backend/bindings/gen/types/FunctionCodeStat.ts`
...
### `backend/bindings/gen/types/Iec104Detail.ts`
...
### `backend/bindings/gen/types/LldpDetail.ts`
...
### `backend/bindings/gen/types/ModbusDetail.ts`
...
### `backend/bindings/gen/types/ModbusDeviceIdInfo.ts`
...
### `backend/bindings/gen/types/ModbusRelationship.ts`
...
### `backend/bindings/gen/types/PacketSummary.ts`
...
### `backend/bindings/gen/types/PollingInterval.ts`
...
### `backend/bindings/gen/types/ProfinetDcpDetail.ts`
...
### `backend/bindings/gen/types/ProtocolStatInfo.ts`
...
### `backend/bindings/gen/types/StoredAlert.ts`
...
### `backend/src/commands/resource_paths.rs`
...
### `backend/src/commands/protocol_handler.rs`
...
### `backend/src/commands/processor.rs`
...
### `backend/src/commands/capture.rs`
...
### `backend/src/commands/analysis.rs`
...
### `backend/src/commands/analysis_input_builder.rs`
...
### `backend/src/commands/capture_context_builder.rs`
...
### `backend/src/commands/patterns.rs`
...
### `backend/src/commands/ingest.rs`
...
### `backend/src/commands/correlation.rs`
...
### `backend/src/commands/baseline.rs`
...
### `backend/src/commands/physical.rs`
...
### `backend/src/commands/projects.rs`
...
### `backend/src/commands/session.rs`
...
### `backend/src/commands/signatures.rs`
...
### `backend/src/commands/export.rs`
...
### `backend/src/commands/segmentation.rs`
...
### `backend/src/commands/wireshark.rs`
...
## Protocol Handler Modules (`backend/src/commands/handlers`)

### `backend/src/commands/handlers/mod.rs`
...
### `backend/src/commands/handlers/modbus.rs`
...
### `backend/src/commands/handlers/dnp3.rs`
...
### `backend/src/commands/handlers/enip.rs`
...
### `backend/src/commands/handlers/s7.rs`
...
### `backend/src/commands/handlers/bacnet.rs`
...
### `backend/src/commands/handlers/iec104.rs`
...
### `backend/src/commands/handlers/profinet.rs`
...
### `backend/src/application/mappers/deep_parse.rs`
...
### `backend/src/application/use_cases/ingest/mod.rs`
...
### `backend/src/application/use_cases/ingest/asset_merge.rs`
...
### `backend/src/application/use_cases/ingest/alert_index.rs`
...
## Signature Rule Files (`backend/signatures`)
...
### `backend/signatures/abb_mac.yaml`
...
### `backend/signatures/bacnet.yaml`
...
### `backend/signatures/bacnet_bvlc.yaml`
...
### `backend/signatures/bacnet_generic.yaml`
...
### `backend/signatures/dnp3_generic.yaml`
...
### `backend/signatures/dnp3_start_bytes.yaml`
...
### `backend/signatures/enip_cip.yaml`
...
### `backend/signatures/ethernet_ip_generic.yaml`
...
### `backend/signatures/ethernet_ip_register_session.yaml`
...
### `backend/signatures/ge_srtp_generic.yaml`
...
### `backend/signatures/hart_ip_generic.yaml`
...
### `backend/signatures/iec104.yaml`
...
### `backend/signatures/iec104_generic.yaml`
...
### `backend/signatures/iec104_start_byte.yaml`
...
### `backend/signatures/modbus_generic.yaml`
...
### `backend/signatures/modbus_server_response.yaml`
...
### `backend/signatures/mqtt_generic.yaml`
...
### `backend/signatures/opc_ua_generic.yaml`
...
### `backend/signatures/opc_ua_hello.yaml`
...
### `backend/signatures/profinet_dcp.yaml`
...
### `backend/signatures/profinet_generic.yaml`
...
### `backend/signatures/rockwell_ethernet_ip.yaml`
...
### `backend/signatures/rockwell_mac.yaml`
...
### `backend/signatures/s7comm.yaml`
...
### `backend/signatures/s7comm_cotp_connect.yaml`
...
### `backend/signatures/s7comm_generic.yaml`
...
### `backend/signatures/schneider_mac.yaml`
...
### `backend/signatures/schneider_modbus.yaml`
...
### `backend/signatures/siemens_s7_mac.yaml`
...
### `backend/signatures/siemens_scalance.yaml`
...
### `backend/signatures/wonderware_suitelink.yaml`
...
## Workspace Crates (`backend/crates`)

## `gm-analysis`

### `backend/crates/gm-analysis/Cargo.toml`
...
### `backend/crates/gm-analysis/src/lib.rs`
...
### `backend/crates/gm-analysis/src/attack_codes.rs`
...
### `backend/crates/gm-analysis/src/helpers.rs`
...
### `backend/crates/gm-analysis/src/attack/` (module directory)
...
### `backend/crates/gm-analysis/src/attack/test_utils.rs`
...
### `backend/crates/gm-analysis/src/context_attacks/` (module directory)
...
### `backend/crates/gm-analysis/src/anomaly.rs`
...
### `backend/crates/gm-analysis/src/comm_patterns.rs`
...
### `backend/crates/gm-analysis/src/purdue.rs`
...
### `backend/crates/gm-analysis/src/risk.rs`
...
### `backend/crates/gm-analysis/src/naming.rs`
...
### `backend/crates/gm-analysis/src/default_creds.rs`
...
### `backend/crates/gm-analysis/src/compliance.rs`
...
### `backend/crates/gm-analysis/src/cve_matcher.rs`
...
### `backend/crates/gm-analysis/src/infrastructure.rs`
...
### `backend/crates/gm-analysis/src/malware_patterns.rs`
...
### `backend/crates/gm-analysis/src/switch_security.rs`
...
### `backend/crates/gm-analysis/src/allowlist.rs`
...
### `backend/crates/gm-analysis/src/error.rs`
...
### `backend/crates/gm-analysis/data/compliance_mappings.json`
...
### `backend/crates/gm-analysis/data/default_credentials.json`
...
### `backend/crates/gm-analysis/data/ics_malware_patterns.json`
...
### `backend/crates/gm-analysis/data/ot_infra_cves.json`
...
### `backend/crates/gm-capture/Cargo.toml`
...
### `backend/crates/gm-capture/src/lib.rs`
...
### `backend/crates/gm-capture/src/error.rs`
...
### `backend/crates/gm-capture/src/interface.rs`
...
### `backend/crates/gm-capture/src/live.rs`
...
### `backend/crates/gm-capture/src/packet.rs`
...
### `backend/crates/gm-capture/src/parsing.rs`
...
### `backend/crates/gm-capture/src/pcap_reader.rs`
...
### `backend/crates/gm-capture/src/pcap_filter.rs`
...
### `backend/crates/gm-types/Cargo.toml`
...
### `backend/crates/gm-types/src/lib.rs`
...
### `backend/crates/gm-db/Cargo.toml`
...
### `backend/crates/gm-db/src/lib.rs`
...
### `backend/crates/gm-db/src/schema.rs`
...
### `backend/crates/gm-db/src/sessions.rs`
...
### `backend/crates/gm-db/src/projects.rs`
...
### `backend/crates/gm-db/src/assets.rs`
...
### `backend/crates/gm-db/src/connections.rs`
...
### `backend/crates/gm-db/src/oui.rs`
...
### `backend/crates/gm-db/src/geoip.rs`
...
### `backend/crates/gm-db/src/error.rs`
...
### `backend/crates/gm-ingest/Cargo.toml`
...
### `backend/crates/gm-ingest/src/lib.rs`
...
### `backend/crates/gm-ingest/src/models.rs`
...
### `backend/crates/gm-ingest/src/zeek.rs`
- For: Zeek TSV parser.
...
### `backend/crates/gm-ingest/src/suricata.rs`
...
### `backend/crates/gm-ingest/src/wazuh.rs`
...
### `backend/crates/gm-ingest/src/nmap.rs`
...
### `backend/crates/gm-ingest/src/masscan.rs`
...
### `backend/crates/gm-ingest/src/sinema.rs`
...
### `backend/crates/gm-ingest/src/error.rs`
...
### `backend/crates/gm-parsers/Cargo.toml`
...
### `backend/crates/gm-parsers/src/lib.rs`
...
### `backend/crates/gm-parsers/src/protocol.rs`
...
### `backend/crates/gm-parsers/src/models.rs`
...
### `backend/crates/gm-parsers/src/modbus.rs`
...
### `backend/crates/gm-parsers/src/dnp3.rs`
...
### `backend/crates/gm-parsers/src/enip.rs`
...
### `backend/crates/gm-parsers/src/s7comm.rs`
...
### `backend/crates/gm-parsers/src/bacnet.rs`
...
### `backend/crates/gm-parsers/src/iec104.rs`
...
### `backend/crates/gm-parsers/src/profinet_dcp.rs`
...
### `backend/crates/gm-parsers/src/lldp.rs`
- For: LLDP parser.
...
### `backend/crates/gm-parsers/src/snmp.rs`
...
### `backend/crates/gm-parsers/src/redundancy.rs`
...
### `backend/crates/gm-parsers/src/vendor_tables.rs`
...
### `backend/crates/gm-physical/Cargo.toml`
...
### `backend/crates/gm-physical/src/lib.rs`
...
### `backend/crates/gm-physical/src/cisco.rs`
...
### `backend/crates/gm-physical/src/juniper.rs`
...
### `backend/crates/gm-physical/src/aruba.rs`
...
### `backend/crates/gm-physical/src/generic.rs`
...
### `backend/crates/gm-physical/src/inference.rs`
...
### `backend/crates/gm-physical/src/error.rs`
...
### `backend/crates/gm-report/Cargo.toml`
...
### `backend/crates/gm-report/src/lib.rs`
...
### `backend/crates/gm-report/src/csv_export.rs`
...
### `backend/crates/gm-report/src/json_export.rs`
...
### `backend/crates/gm-report/src/pdf.rs`
...
### `backend/crates/gm-report/src/sbom.rs`
...
### `backend/crates/gm-report/src/stix.rs`
...
### `backend/crates/gm-report/src/error.rs`
...
### `backend/crates/gm-segmentation/Cargo.toml`
...
### `backend/crates/gm-segmentation/src/lib.rs`
...
### `backend/crates/gm-segmentation/src/identity_groups.rs`
...
### `backend/crates/gm-segmentation/src/zones.rs`
...
### `backend/crates/gm-segmentation/src/matrix.rs`
...
### `backend/crates/gm-segmentation/src/enforcement.rs`
...
### `backend/crates/gm-segmentation/src/simulation.rs`
...
### `backend/crates/gm-segmentation/src/error.rs`
...
### `backend/crates/gm-signatures/Cargo.toml`
...
### `backend/crates/gm-signatures/src/lib.rs`
...
### `backend/crates/gm-signatures/src/signature.rs`
...
### `backend/crates/gm-signatures/src/engine.rs`
...
### `backend/crates/gm-signatures/src/error.rs`
...
### `backend/crates/gm-topology/Cargo.toml`
...
### `backend/crates/gm-topology/src/lib.rs`
